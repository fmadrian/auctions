...
namespace AuctionService.Data
{
    public class DBInitializer
    {
        public static void InitDb(WebApplication app)
        {
            ...
            DBInitializer.SeedData(scope.ServiceProvider.GetService<ApplicationDbContext>());
        ...
        private static void SeedData(ApplicationDbContext context)
        {
            ...
            // If there's auctions in the database, it exits the method.
            if (context.Auctions.Any())
            {
                return;
            }
            // Instantiate the auctions.
            ...
            // Add the changes to the context (in memory).
